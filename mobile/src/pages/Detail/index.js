...
export default function Incidents(){
    ...
    const message = `Ola ${incident.nome}. Estou entrando em contato pois gostaria de ajudar no caso: "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR', {style: 'currency', currency: 'BRL'}).format(incident.value)}`;
